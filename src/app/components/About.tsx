...
export default function About() {
  return (
    <section id="about" className="mb-24 py-24 bg-gradient-to-br from-blue-50 to-green-50 overflow-hidden">
      <div className="container mx-auto px-4 relative">
        <motion.h3
          className="text-4xl font-bold mb-12 text-blue-600 text-center"
        ...
        <div className="max-w-4xl mx-auto relative">
          <motion.div
            className="absolute top-0 left-0 w-20 h-20 bg-blue-200 rounded-full opacity-50 -z-10"
            animate={{
              scale: [1, 1.2, 1],
              rotate: [0, 90, 0],
            }}
          ...
          />
          <motion.div
            className="absolute bottom-0 right-0 w-32 h-32 bg-green-200 rounded-full opacity-50 -z-10"
            animate={{
              scale: [1, 1.3, 1],
              rotate: [0, -90, 0],
            }}
