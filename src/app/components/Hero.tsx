    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white">
        <h2 className="text-5xl font-bold mb-6 animate-fade-in-up">
          Collective Intelligence, Global Impact
        </h2>
        <p className="text-xl mb-10 max-w-3xl mx-auto animate-fade-in-up animation-delay-300">
          Empowering the future with AI-driven ventures, blockchain integration,
          and self-sovereign identity.
        </p>
        <a
          href="#"
          className="bg-white text-blue-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-gray-100 transition-colors inline-block animate-fade-in-up animation-delay-600"
        >
          Get Started
        </a>
      </div>
