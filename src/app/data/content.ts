export const content = {
  ...
  features: {
    ...
    items: [
      {
        title: "AI Agents",
        imagePath: "https://placeholderimage.eu/api/AI",
        description:
      ...
      },
      {
        ...
        imagePath: "https://placeholderimage.eu/api/Blockchain",
        description:
      ...
      },
      {
        ...
        imagePath: "https://placeholderimage.eu/api/SSI",
        description:
    ...
    resources: [
      {
        ...
        imagePath: "https://placeholderimage.eu/api/AIBusiness",
        description: "Learn how AI is transforming business operations.",
      },
      {
        title: "Blockchain Basics",
        imagePath: "https://placeholderimage.eu/api/BlockchainBasics",
        description: "Understand the fundamentals of blockchain technology.",
      },
      {
        title: "SSI Explained",
        imagePath: "https://placeholderimage.eu/api/SSIExplained",
        description: "Discover the power of Self-Sovereign Identity.",
      },
      {
        title: "Future of Work",
        imagePath: "https://placeholderimage.eu/api/FutureOfWork",
